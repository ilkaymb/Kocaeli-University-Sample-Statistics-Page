...
function Burslar() {
    return (
      ...
      <div style={{padding:"25px",color:'rgba(6, 57, 128, 1)'}}>
           <h1 className="header"  style={{color:'rgba(6, 57, 128, 1)'}}>ÖĞRENCİLERE VERİLEN DESTEK </h1>
 ...
 <Row >
   <Col lg={8} md={24}  smHidden>
    <div  style={{display:'flex',justifyContent:'end',alignItems:'center',color:'rgba(6, 57, 128, 1)'}}><TfiWallet size="35%"/></div>
